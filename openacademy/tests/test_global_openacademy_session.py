...
class GlobalTestOpenacademySession(TransactionCase):
    '''
    This is for create global test to sessions
    '''
    ...
    def test_20_wkf_done(self):
        ...
        self.assertEqual(session_test.state,
                         'draft', 'Initial state should be in "draft"')

        # Change to next state and check it
        ...
        # self.env.cr.commit()  # Just to test the data generate. Don't use!
